...
def MENSAGENS_ERROS(info_usuario):
    ...
    >>> MENSAGENS_ERROS(info_usuario)
      Olá, seja bem-vindo(a) ao nosso controle de dieta...Espero
    que sejamos bons amigos!
      Peço que preencha sempre todos os dados sincera e adequadamente,
    e lembre-se,estou aqui para ajudar-lhe...
    <BLANKLINE>
      Observação Importante:
      Este programa serve apenas como controle,não substitui um acompanhamento médico.
    <BLANKLINE>
      Abaixo você tem o gráfico com as quantidades ingeridas por dia durante sua dieta.
      Você recebeu também um arquivo de texto localizado com um relatório final na mesma
    pasta que os arquivos do programa.
      Não esqueça de vê-lo para mais informações.
    1
    '''
    ...
    if (info_usuario['SEXO']) not in ("homem","mulher","masculino","feminino","M","H"):
      ...
      #Boas vindas  
    print('''  Olá, seja bem-vindo(a) ao nosso controle de dieta...Espero
que sejamos bons amigos!
  Peço que preencha sempre todos os dados sincera e adequadamente,
e lembre-se,estou aqui para ajudar-lhe...
